...
- `docs/smart-speaker-client-播放模式与语音恢复策略更新说明.md`（**播放模式精简、模式切换 TTS、ASR 超时恢复、短 WAV 播放统一**；含论文可引用要点）
- `docs/smart-speaker-client-本次改动文件清单.md`（含分文件拆分后模块对应关系）
- `docs/smart-speaker-client-全量重构实施记录.md`
- `docs/smart-speaker-client-全量测试结果.md`
- `docs/orangepi-3.5mm-音频驱动说明.md`（含 hw:3,0 立体声要求）
